...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://192.168.168.129:3316/tingshu_user?serverTimezone=GMT%2B8",
                        "root",
                        "123")
                .globalConfig(builder -> {
                    builder.author("林长启") // 设置作者
                            ...
                            .disableOpenDir()
                            .outputDir("D:\\tingshu_project\\code\\tingshu_parent\\tingshu_core\\tingshu_user\\src\\main\\java"); // 指定输出目录
                })

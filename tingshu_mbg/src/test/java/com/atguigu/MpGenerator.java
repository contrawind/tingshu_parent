    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://192.168.168.129:3316/tingshu_album?serverTimezone=GMT%2B8",
                ...
                .globalConfig(builder -> {
                    builder.author("林长启") // 设置作者
                            //.enableSwagger() // 开启 swagger 模式
                            .disableOpenDir()
                            .outputDir("D:\\tingshu_project\\code\\tingshu_parent\\tingshu_core\\tingshu_album\\src\\main\\java"); // 指定输出目录
                })
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("album_info", "album_stat", "base_attribute", "base_category_view", "album_attribute_value", "base_attribute_value", "base_category1", "base_category2", "base_category3", "track_info", "track_stat");// 设置需要生成的表名
